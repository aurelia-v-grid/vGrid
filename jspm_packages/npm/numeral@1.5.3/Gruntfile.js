...
module.exports = function(grunt) {
  var minifiedFiles = {
    ...
    'min/languages.min.js': ['languages.js']
  };
  ...
  grunt.initConfig({
    ...
    jshint: {
      all: ['Gruntfile.js', 'numeral.js', 'languages/**/*.js'],
      options: {
        'node': true,
        'browser': true,
        'curly': true,
  ...
  grunt.registerTask('build', ['jshint', 'nodeunit', 'concat', 'uglify']);
