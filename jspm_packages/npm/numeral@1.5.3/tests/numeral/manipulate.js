...
exports.manipulate = {
  add: function(test) {
    test.expect(4);
    var tests = [[1000, 10, 1010], [0.5, 3, 3.5], [-100, 200, 100], [0.1, 0.2, 0.3]],
        num;
  ...
  subtract: function(test) {
    test.expect(4);
    var tests = [[1000, 10, 990], [0.5, 3, -2.5], [-100, 200, -300], [0.3, 0.1, 0.2]],
        num;
    for (var i = 0; i < tests.length; i++) {
      num = numeral(tests[i][0]);
  ...
  multiply: function(test) {
    test.expect(4);
    var tests = [[1000, 10, 10000], [0.5, 3, 1.5], [-100, 200, -20000], [0.1, 0.2, 0.02]],
        num;
    for (var i = 0; i < tests.length; i++) {
      num = numeral(tests[i][0]);
  ...
  divide: function(test) {
    test.expect(4);
    var tests = [[1000, 10, 100], [0.5, 3, 0.16666666666666666], [-100, 200, -0.5], [5.3, 0.1, 53]],
        num;
    for (var i = 0; i < tests.length; i++) {
      num = numeral(tests[i][0]);
  ...
  difference: function(test) {
    test.expect(4);
    var tests = [[1000, 10, 990], [0.5, 3, 2.5], [-100, 200, 300], [0.3, 0.2, 0.1]],
        num;
    for (var i = 0; i < tests.length; i++) {
      num = numeral(tests[i][0]);
