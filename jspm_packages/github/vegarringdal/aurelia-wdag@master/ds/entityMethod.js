...
define(["exports"], function (exports) {
    ...
    var EntityMethod = exports.EntityMethod = function () {
        function EntityMethod(source, name) {
            _classCallCheck(this, EntityMethod);

            this.source = source;
            this.name = name;
        }

        EntityMethod.prototype.execute = function execute(params, options) {
            var _this = this;
