...
System.register([], function (_export, _context) {
  ...
  return {
    setters: [],
    execute: function () {
      _export('ColumnMarkupHelper', ColumnMarkupHelper = function () {
        function ColumnMarkupHelper() {
          _classCallCheck(this, ColumnMarkupHelper);
        ...
        ColumnMarkupHelper.prototype.generate = function generate(colConfig) {
        ...
        ColumnMarkupHelper.prototype.processColumns = function processColumns(array) {
          var _this = this;
        ...
        ColumnMarkupHelper.prototype.createHeaderTemplate = function createHeaderTemplate(col) {
          if (!col.colHeaderTemplate) {
            ...
            switch (col.colType) {
              ...
              case "selection":
                labelHeader = '';
                inputHeader = '<input class="avg-row-checkbox-100" v-selection="header" type="checkbox">';
                break;
        ...
        ColumnMarkupHelper.prototype.createRowTemplate = function createRowTemplate(col) {
          if (!col.colRowTemplate) {

            switch (col.colType) {

              case "selection":
                col.colRowTemplate = '<input v-key-move class="avg-row-checkbox-100"  v-selection="row" type="checkbox" >';
                break;
        ...
        ColumnMarkupHelper.prototype.checkAttribute = function checkAttribute(attribute) {
          var value = attribute;
          if (attribute) {
        ...
        ColumnMarkupHelper.prototype.createImageRowMarkup = function createImageRowMarkup(col) {
        ...
        ColumnMarkupHelper.prototype.createInputRowMarkup = function createInputRowMarkup(col) {
        ...
        ColumnMarkupHelper.prototype.createInputHeaderMarkup = function createInputHeaderMarkup(col) {
          var markup = void 0;
          if (col.colFilter) {
            ...
            markup = '<input  v-menu="filter:cool" ' + classNames + ' ' + colAddFilterAttributes + ' ' + type + ' ' + filter + '">';
          } else {
            markup = '';
          }
        ...
        ColumnMarkupHelper.prototype.createLabelMarkup = function createLabelMarkup(col) {
      ...
      _export('ColumnMarkupHelper', ColumnMarkupHelper);
    }
  };
});
