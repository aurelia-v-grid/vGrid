...
System.register(['aurelia-framework', './mainMarkup', './mainScrollEvents', './rowMarkup', './rowScrollEvents', './columnMarkup', './htmlCache', './htmlHeightWidth', './viewSlots', './columnBindingContext', './rowDataBinder', './rowClickHandler', './groupingElements', './controller', './loadingScreen'], function (_export, _context) {
  "use strict";

  var bindable, ViewCompiler, Container, ViewResources, TaskQueue, MainMarkup, MainScrollEvents, RowMarkup, RowScrollEvents, ColumnMarkup, HtmlCache, HtmlHeightWidth, ViewSlots, ColumnBindingContext, RowDataBinder, RowClickHandler, GroupingElements, Controller, LoadingScreen, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _desc, _value, _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _class2, _temp, VGrid;
  ...
  return {
    ...
    execute: function () {
      _export('VGrid', VGrid = (_dec = bindable({ attribute: "v-row-height" }), _dec2 = bindable({ attribute: "v-header-height" }), _dec3 = bindable({ attribute: "v-footer-height" }), _dec4 = bindable({ attribute: "v-panel-height" }), _dec5 = bindable({ attribute: "v-grid-connector" }), _dec6 = bindable({ attribute: "v-multi-select" }), _dec7 = bindable({ attribute: "v-manual-sel" }), _dec8 = bindable({ attribute: "v-theme" }), (_class = (_temp = _class2 = function () {
        ...
        VGrid.prototype.bind = function bind(bindingContext, overrideContext) {
          ...
          this.attManualSelection = this.attManualSelection ? true : false;
