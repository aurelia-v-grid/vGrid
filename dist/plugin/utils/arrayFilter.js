...
System.register([], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ArrayFilter", ArrayFilter = function () {
        function ArrayFilter(filterOperators) {
          _classCallCheck(this, ArrayFilter);

          this.filterOperators = filterOperators;
          this.lastFilter = [];
        }

        ArrayFilter.prototype.getLastFilter = function getLastFilter() {
          return this.lastFilter;
        };

        ArrayFilter.prototype.runQueryOn = function runQueryOn(objArray, ObjFilter) {
      ...
      _export("ArrayFilter", ArrayFilter);
    }
  };
});
