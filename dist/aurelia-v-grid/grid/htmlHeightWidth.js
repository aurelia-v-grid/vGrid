...
System.register([], function (_export, _context) {
    ...
    return {
        setters: [],
        execute: function () {
            _export("HtmlHeightWidth", HtmlHeightWidth = function () {
                function HtmlHeightWidth() {
                    _classCallCheck(this, HtmlHeightWidth);
                ...
                HtmlHeightWidth.prototype.setCollectionLength = function setCollectionLength(length) {
                ...
                HtmlHeightWidth.prototype.addDefaultsAttributes = function addDefaultsAttributes(attHeaderHeight, attRowHeight, attFooterHeight, attPanelHeight) {
                ...
                HtmlHeightWidth.prototype.adjustWidthsColumns = function adjustWidthsColumns(columnBindingContext, groupsLength) {
                ...
                HtmlHeightWidth.prototype.setWidthFromColumnConfig = function setWidthFromColumnConfig(colConfig, groupsLength) {
                    var left = groupsLength ? groupsLength * 15 : 0;
                    var main = 0;
                    var right = 0;
                ...
                HtmlHeightWidth.prototype.getScrollbarWidth = function getScrollbarWidth() {
            ...
            _export("HtmlHeightWidth", HtmlHeightWidth);
        }
    };
});
