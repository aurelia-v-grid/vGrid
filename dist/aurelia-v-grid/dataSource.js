...
System.register(['./selection', './collection', './utils/arrayHelper'], function (_export, _context) {
  "use strict";

  var Selection, Collection, ArrayHelper, DataSource;
  ...
  return {
    setters: [function (_selection) {
      Selection = _selection.Selection;
    }, function (_collection) {
      Collection = _collection.Collection;
    }, function (_utilsArrayHelper) {
      ArrayHelper = _utilsArrayHelper.ArrayHelper;
    }],
    execute: function () {
      _export('DataSource', DataSource = function () {
        ...
        DataSource.prototype.triggerEvent = function triggerEvent(event) {
          this.eventCallBacks.forEach(function (FN) {
            FN(event);
          });
        };

        DataSource.prototype.addEventListener = function addEventListener(callback) {
          this.eventIdCount++;
        ...
        DataSource.prototype.getRowKey = function getRowKey(row) {
          if (this.collection) {
        ...
        DataSource.prototype.getRowFromKey = function getRowFromKey(key) {
          if (this.collection) {
        ...
        DataSource.prototype.setArray = function setArray(array) {
          this.collection = new Collection(this);
        ...
        DataSource.prototype.query = function query(options) {
          if (options) {
        ...
        DataSource.prototype.orderBy = function orderBy(attribute, addToCurrentSort) {
        ...
        DataSource.prototype.getCurrentOrderBy = function getCurrentOrderBy() {
          return this.arrayHelper.getOrderBy();
        };

        DataSource.prototype.getCurrentFilter = function getCurrentFilter() {
          return this.arrayHelper.getCurrentFilter();
        };

        DataSource.prototype.getElement = function getElement(row) {
          return this.collection.getRow(row);
        };

        DataSource.prototype.group = function group(grouping, keepExpanded) {
          var _this = this;
        ...
        DataSource.prototype.groupCollapse = function groupCollapse(id) {
        ...
        DataSource.prototype.groupExpand = function groupExpand(id) {
        ...
        DataSource.prototype.getFilterOperatorName = function getFilterOperatorName(operator) {
          return this.arrayHelper.getFilterOperatorName(operator);
        };

        DataSource.prototype.getGrouping = function getGrouping() {
          return this.arrayHelper.getGrouping();
        };

        DataSource.prototype.addElement = function addElement(data) {
          if (data) {} else {
            var newElement = {};
            this.mainArray.unshift(newElement);
            var oldArray = this.collection.getEntities();
            var oldMaybeGroupedArray = this.collection.entities;
