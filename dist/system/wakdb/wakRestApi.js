System.register(["aurelia-fetch-client", "./wakDataClass", "./wakDataSource", "./wakRestUtil", "./wakDirectory"], function (exports_1, context_1) {
    var __moduleName = context_1 && context_1.id;
    var aurelia_fetch_client_1, wakDataClass_1, wakDataSource_1, wakRestUtil_1, wakDirectory_1, WakRestApi;
    return {
        setters: [
            function (aurelia_fetch_client_1_1) {
                aurelia_fetch_client_1 = aurelia_fetch_client_1_1;
            },
            function (wakDataClass_1_1) {
                wakDataClass_1 = wakDataClass_1_1;
            },
            function (wakDataSource_1_1) {
                wakDataSource_1 = wakDataSource_1_1;
            },
            function (wakRestUtil_1_1) {
                wakRestUtil_1 = wakRestUtil_1_1;
            },
            function (wakDirectory_1_1) {
                wakDirectory_1 = wakDirectory_1_1;
            }
        ],
        execute: function () {
            WakRestApi = (function () {
            ...
            exports_1("WakRestApi", WakRestApi);
        }
    };
});
