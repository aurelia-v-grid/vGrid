System.register(["./wakEntity"], function (exports_1, context_1) {
    var __moduleName = context_1 && context_1.id;
    var wakEntity_1, WakCollection;
    return {
        setters: [
            function (wakEntity_1_1) {
                wakEntity_1 = wakEntity_1_1;
            }
        ],
        execute: function () {
            WakCollection = (function () {
            ...
            exports_1("WakCollection", WakCollection);
        }
    };
});
