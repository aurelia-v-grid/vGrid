...
var VGrid = (function () {
    function VGrid(element, viewCompiler, container, viewResources, taskQueue) {
        ...
        this.contextMenu = new ContextMenu(viewCompiler, container, viewResources, this.viewSlots, this.controller);
        this.footer = new Footer(this.htmlCache, viewCompiler, container, viewResources, this.viewSlots);
    ...
    VGrid.inject = [Element, ViewCompiler, Container, ViewResources, TaskQueue];
    __decorate([
        bindable({ attribute: 'v-row-height' }),
        __metadata("design:type", Number)
    ], VGrid.prototype, "attRowHeight", void 0);
    __decorate([
        bindable({ attribute: 'v-skip-passive' }),
        __metadata("design:type", Boolean)
    ], VGrid.prototype, "attSkipPassive", void 0);
    __decorate([
        bindable({ attribute: 'v-header-height' }),
        __metadata("design:type", Number)
    ], VGrid.prototype, "attHeaderHeight", void 0);
    __decorate([
        bindable({ attribute: 'v-footer-height' }),
        __metadata("design:type", Number)
    ], VGrid.prototype, "attFooterHeight", void 0);
    __decorate([
        bindable({ attribute: 'v-panel-height' }),
        __metadata("design:type", Number)
    ], VGrid.prototype, "attPanelHeight", void 0);
    __decorate([
        bindable({ attribute: 'v-grid-connector' }),
        __metadata("design:type", Object)
    ], VGrid.prototype, "attGridConnector", void 0);
    __decorate([
        bindable({ attribute: 'v-multi-select' }),
        __metadata("design:type", Boolean)
    ], VGrid.prototype, "attMultiSelect", void 0);
    __decorate([
        bindable({ attribute: 'v-manual-sel' }),
        __metadata("design:type", Boolean)
    ], VGrid.prototype, "attManualSelection", void 0);
    __decorate([
        bindable({ attribute: 'v-theme' }),
        __metadata("design:type", String)
    ], VGrid.prototype, "attTheme", void 0);
    __decorate([
        bindable({ attribute: 'v-row-on-draw' }),
        __metadata("design:type", Function)
    ], VGrid.prototype, "attOnRowDraw", void 0);
    __decorate([
        bindable({ attribute: 'v-columns' }),
        __metadata("design:type", Array)
    ], VGrid.prototype, "attColConfig", void 0);
    __decorate([
        bindable({ attribute: 'v-i18n' }),
        __metadata("design:type", Function)
    ], VGrid.prototype, "attI18N", void 0);
    __decorate([
        bindable({ attribute: 'v-data-delay' }),
        __metadata("design:type", Number)
    ], VGrid.prototype, "attDataDelay", void 0);
    __decorate([
        bindable({ attribute: 'v-variable-row-height' }),
        __metadata("design:type", Boolean)
