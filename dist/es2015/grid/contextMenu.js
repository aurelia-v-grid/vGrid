define(["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    var ContextMenu = (function () {
        function ContextMenu(viewCompiler, container, viewResources, viewSlots) {
            ...
            this.menuStringsBrackes = {
                close: '${menuStrings.close}',
                pinLeft: '${menuStrings.pinLeft}',
                pinRight: '${menuStrings.pinRight}',
                groupBy: '${menuStrings.groupBy}',
                sortAscending: '${menuStrings.sortAscending}',
                sortDescending: '${menuStrings.sortDescending}',
                showAll: '${menuStrings.showAll}',
                clearCurrent: '${menuStrings.clearCurrent}',
                clearAll: '${menuStrings.clearAll}',
                chooseOperator: '${menuStrings.chooseOperator}',
                back: '${menuStrings.back}',
                equals: '${menuStrings.equals}',
                lessThanOrEqual: '${menuStrings.lessThanOrEqual}',
                greaterThanOrEqual: '${menuStrings.greaterThanOrEqual}',
                lessThan: '${menuStrings.lessThan}',
                greaterThan: '${menuStrings.greaterThan}',
                contains: '${menuStrings.contains}',
                notEqualTo: '${menuStrings.notEqualTo}',
                doesNotContain: '${menuStrings.doesNotContain}',
                beginsWith: '${menuStrings.beginsWith}',
                endsWith: '${menuStrings.endsWith}'
            };
