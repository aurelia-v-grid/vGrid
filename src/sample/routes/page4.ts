...
export class Page3 {
    ...
    public canActivate(_a: any, b: { title: string; }, _c: any) {
        this.title = b.title;
    }
    ...
    public translateI18n(_key: string) {
    ...
    public onRowDraw(data: { tempRef: { number: number; numberColor: string; numberFont: string; }; }) {
