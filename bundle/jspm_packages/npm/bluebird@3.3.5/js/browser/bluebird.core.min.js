  ...
  !function(t) {
    ...
    return function r(t, e, n) {
      ...
      15: [function(t, e, n) {
        ...
        e.exports = function() {
          ...
          s = f.isNode ? function() {
            ...
            return null;
          }, f.notEnumerableProp(r, "_getDomain", s);
          var h = t("./es5"),
              _ = t("./async"),
              d = new _;
          h.defineProperty(r, "_async", {value: d});
          var v = t("./errors"),
          ...
          var m = function() {},
              ...
              C = {},
              k = t("./thenables")(r, m),
              w = t("./promise_array")(r, m, k, u, e),
              E = t("./context")(r),
              j = (E.create, t("./debuggability")(r, E)),
              F = (j.CapturedTrace, t("./finally")(r, k)),
              T = t("./catch_filter")(C),
              O = t("./nodeback"),
              P = f.errorObj,
              R = f.tryCatch;
          return r.prototype.toString = function() {
            ...
            if (e > 1) {
              ...
              for (n = 0; e - 1 > n; ++n) {
                var o = arguments[n];
                if (!f.isObject(o))
                  return u("expecting an object but got " + f.classString(o));
                r[i++] = o;
              }
            ...
            return "function" != typeof t ? u("expecting a function but got " + f.classString(t)) : this.all()._then(t, void 0, void 0, b, void 0);
            ...
            if ("function" != typeof t)
              throw new y("expecting a function but got " + f.classString(t));
            ...
            var a = void 0 !== o,
                ...
                l = this._target(),
                u = l._bitField;
            a || (c._propagateFrom(this, 3), c._captureStackTrace(), void 0 === i && 0 !== (2097152 & this._bitField) && (i = 0 !== (50397184 & u) ? this._boundValue() : l === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, c));
            var p = s();
            if (0 !== (50397184 & u)) {
              var f,
                  h,
                  _ = l._settlePromiseCtx;
              0 !== (33554432 & u) ? (h = l._rejectionHandler0, f = t) : 0 !== (16777216 & u) ? (h = l._fulfillmentHandler0, f = e, l._unsetRejectionIsUnhandled()) : (_ = l._settlePromiseLateCancellationObserver, h = new g("late cancellation observer"), l._attachExtraTrace(h), f = e), d.invoke(_, l, {
            ...
            if (o >= 65531 && (o = 0, this._setLength(0)), 0 === o)
              this._promise0 = n, this._receiver0 = r, "function" == typeof t && (this._fulfillmentHandler0 = null === i ? t : i.bind(t)), "function" == typeof e && (this._rejectionHandler0 = null === i ? e : i.bind(e));
            else {
              var a = 4 * o - 4;
              this[a + 2] = n, this[a + 3] = r, "function" == typeof t && (this[a + 0] = null === i ? t : i.bind(t)), "function" == typeof e && (this[a + 1] = null === i ? e : i.bind(e));
            }
            ...
            if (0 === (65536 & i)) {
              r._pushContext();
              var o;
              e === b ? n && "number" == typeof n.length ? o = R(t).apply(this._boundValue(), n) : (o = P, o.e = new y("cannot .spread() a non-array: " + f.classString(n))) : o = R(t).call(e, n);
              var a = r._popContext();
              i = r._bitField, 0 === (65536 & i) && (o === C ? r._reject(n) : o === P ? r._rejectCallback(o.e, !1) : (j.checkForgottenReturns(o, a, "", r, this), r._resolveCallback(o)));
            }
            ...
            var a = t instanceof r,
                s = this._bitField,
                c = 0 !== (134217728 & s);
            0 !== (65536 & s) ? (a && t._invokeInternalOnCancel(), i instanceof F && i.isFinallyHandler() ? (i.cancelPromise = t, R(n).call(i, o) === P && t._reject(P.e)) : n === l ? t._fulfill(l.call(i)) : i instanceof e ? i._promiseCancelled(t) : a || t instanceof w ? t._cancel() : i.cancel()) : "function" == typeof n ? a ? (c && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(n, i, o, t)) : n.call(i, o, t) : i instanceof e ? i._isResolved() || (0 !== (33554432 & s) ? i._promiseFulfilled(o, t) : i._promiseRejected(o, t)) : a && (c && t._setAsyncGuaranteed(), 0 !== (33554432 & s) ? t._fulfill(o) : t._reject(o));
            ...
            var e = this._bitField;
            if (!((117506048 & e) >>> 16))
              return this._setRejected(), this._fulfillmentHandler0 = t, this._isFinal() ? d.fatalError(t, f.isNode) : void((65535 & e) > 0 ? d.settlePromises(this) : this._ensurePossibleRejectionHandled());
          ...
          }, f.notEnumerableProp(r, "_makeSelfResolutionError", c), t("./method")(r, m, k, u, j), t("./bind")(r, m, k, j), t("./cancel")(r, w, u, j), t("./direct_resolve")(r), t("./synchronous_inspection")(r), t("./join")(r, w, k, m, j), r.Promise = r, f.toFastProperties(r), f.toFastProperties(r.prototype), a({a: 1}), a({b: 2}), a({c: 3}), a(1), a(function() {}), a(void 0), a(!1), a(new r(m)), j.setBounds(_.firstLineError, f.lastLineError), r;
        };
      }, {
        "./async": 1,
        "./bind": 2,
      ...
      21: [function(t, e, n) {
        ...
        function b(t) {
          return y(t) && j.propertyIsWritable(t, "stack");
        }
        function C(t) {
        ...
        if ("undefined" != typeof Symbol && Symbol.iterator) {
          ...
          L = function(t) {
            return j.isArray(t) ? t : null != t && "function" == typeof t[Symbol.iterator] ? I(t) : null;
          };
        }
